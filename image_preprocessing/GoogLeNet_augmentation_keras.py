...
def train_model(model, options):
    ...
    train_datagen = ImageDataGenerator(preprocessing_function = preprocessing, rotation_range = 30)
...
if __name__ == '__main__':
    ...
    # pre_dir = '/data/Linlin/GoogLeNet_inputs_patients'
