...
def generate_kmeans_model(num_clusters, root_dir, method_folder):
...
def generate_patient_bow_feats(folder, method_folder, kmeans_model, num_clusters):
    '''
    ...
    '''
    # 1. read files about slices
    feat_googLeNet_path = os.path.join(options['root_dir'], 'output', method_folder)
...
def main_funct(options):
    ...
    kmeans_model = generate_kmeans_model(num_clusters, root_dir, method_folder)
    # 2. extract patients' BOW feats of train data and train svm model
    folder = 'train'
    train_patients_bow, train_patient_label_gt = generate_patient_bow_feats(folder, method_folder, kmeans_model, num_clusters)
    ...
    folder = 'vald'
    vald_patients_bow, vald_patient_label_gt = generate_patient_bow_feats(folder, method_folder, kmeans_model, num_clusters)
    ...
    out_dir = os.path.join(root_dir, 'output', method_folder)
...
if __name__ == '__main__':
    ...
    root_dir = os.path.join(options['root_dir'], options['category_folder_name'])
