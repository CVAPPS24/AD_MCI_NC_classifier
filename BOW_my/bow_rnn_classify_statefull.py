...
def transfer_rnn_input1(patients_bow, patients_label_gt, max_timesteps, folder):
...
def main_funct(in_folder_name, options):
    ...
    print '-------------Train RNN model with Stateful-------------'
    ...
    train_patients_bow_in, train_patient_label_gt_in = transfer_rnn_input1(train_patients_bow, train_patient_label_gt, max_timesteps, folder)
    folder = 'vald'
    vald_patients_bow, vald_patient_label_gt = patient_feats(folder, in_folder_name, kmeans_model, num_clusters)
    vald_patients_bow_in, vald_patient_label_gt_in = transfer_rnn_input1(vald_patients_bow, vald_patient_label_gt, max_timesteps, folder)
    ...
    vald_matrx = rnn_model.evaluate(vald_patients_bow_in, vald_patient_label_gt_in, batch_size = options['batch_size'] )
    print('\nVald loss and acc')
    print(vald_matrx)
    folder = 'test'
    vald_patients_bow, vald_patient_label_gt = patient_feats(folder, in_folder_name, kmeans_model, num_clusters)
    test_patients_bow_in, test_patient_label_gt_in = transfer_rnn_input1(vald_patients_bow, vald_patient_label_gt, max_timesteps, folder)
